...
{
    public class ExtendedFishFarmAI : PlayerBuildingAI, IExtendedBuildingAI
    {
        ...
        [CustomizableProperty("Position", "Extraction positions")]
        public Vector3[] m_extractionPositions;
        ...
        protected override void ProduceGoods(ushort buildingID, ref Building buildingData, ref Building.Frame frameData, int productionRate, int finalProductionRate, ref Citizen.BehaviourData behaviour, int aliveWorkerCount, int totalWorkerCount, int workPlaceCount, int aliveVisitorCount, int totalVisitorCount, int visitPlaceCount)
        {
            ...
            int num2 = 0;
            int num3 = 0;
            if (m_extractionPositions != null && m_extractionPositions.Length > 0)
            {
                for (int i = 0; i < m_extractionPositions.Length; i++)
                {
                    Vector3 position = buildingData.CalculatePosition(m_extractionPositions[i]);
                ...
                num2 = num / m_extractionPositions.Length;
            }
            else
            {
