            ...
            switch (infoMode)
            {
                ...
                case InfoManager.InfoMode.Connections:
                    if (subInfoMode == InfoManager.SubInfoMode.WaterPower)
                    {
                        ...
                        if (DistrictPark.IsPedestrianReason(outputResource, out var index))
                        {
