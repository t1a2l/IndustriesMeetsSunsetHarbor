    ...
    public class DropDown : UIPanel
    {
        ...
        public override void OnDestroy()
        {
            if (_triggerButton != null)
                Destroy(_triggerButton.gameObject);
            if (_dropDownPanel != null)
                Destroy(_dropDownPanel.gameObject);
            if (_scrollablePanel != null)
                Destroy(_scrollablePanel.gameObject);
            if (_scrollbarPanel != null)
                Destroy(_scrollbarPanel.gameObject);
            if (_scrollbar != null)
