...
namespace FishIndustryEnhanced
{
    ...
    public static class UniqueFactoryWorldInfoPanelAI
    {
        ...
        public static void Postfix(UniqueFactoryWorldInfoPanel __instance)
		{
            ...
            var m_inputResourceCount = (int)typeof(UniqueFactoryWorldInfoPanel).GetField("m_inputResourceCount", BindingFlags.NonPublic | BindingFlags.Instance).GetValue(__instance);
            var m_inputs = (UITemplateList<UIPanel>)typeof(UniqueFactoryWorldInfoPanel).GetField("m_inputs", BindingFlags.NonPublic | BindingFlags.Instance).GetValue(__instance);
            var m_horizontalLine = (UIPanel)typeof(UniqueFactoryWorldInfoPanel).GetField("m_horizontalLine", BindingFlags.NonPublic | BindingFlags.Instance).GetValue(__instance);
            var m_inputContainer = (UIPanel)typeof(UniqueFactoryWorldInfoPanel).GetField("m_inputContainer", BindingFlags.NonPublic | BindingFlags.Instance).GetValue(__instance);
            ...
            var m_productBuffer = (UIProgressBar)typeof(UniqueFactoryWorldInfoPanel).GetField("m_productBuffer", BindingFlags.NonPublic | BindingFlags.Instance).GetValue(__instance);
            var m_productionSlider = (UISlider)typeof(UniqueFactoryWorldInfoPanel).GetField("m_productionSlider", BindingFlags.NonPublic | BindingFlags.Instance).GetValue(__instance);
